...
const BuyerDashboard = () => {
  ...
  const handleCartCheckout = (cart) => {
    setShowCart(false);
    // For now, just show a message. In a real app, you'd navigate to checkout
    showToast('Please select items from cart to checkout', 'info');
  };
            ...
            <div className="modal-body">
              ...
              <div className="modal-details">
                ...
                <div className="detail-section">
                  ...
                  <p><strong>Status:</strong> <span className={`status-badge ${selectedProduct.status}`}>{selectedProduct.status}</span></p>
                </div>
                <div className="detail-section">
                ...
                <div className="product-action-buttons">
                  ...
                  >
                    {selectedProduct.status === 'available' ? 'Buy Now' : 'Sold'}
                  </button>
            ...
            <div className="payment-body">
              ...
              <div className="payment-actions">
                <button className="cancel-btn" onClick={() => {
                  setShowPayment(false);
                  setPaymentMethod('COD'); // Reset on cancel
                }}>
                  Cancel
                </button>
