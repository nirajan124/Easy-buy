...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (result.success) {
      ...
      // Check if account is deactivated (case-insensitive)
  ...
  const handleDeactivatedModalClose = () => {
    ...
    // Navigate to contact page after modal is closed
    navigate('/contact?deactivated=true');
  };
  ...
  return (
    <div className="login-container">
      ...
      {showDeactivatedModal && (
        <div className="modal-overlay" onClick={handleDeactivatedModalClose}>
          <div className="modal-content deactivated-modal" onClick={(e) => e.stopPropagation()}>
            <button className="close-btn" onClick={handleDeactivatedModalClose}>×</button>
            ...
            <div className="modal-actions">
              <button 
                ...
                onClick={handleDeactivatedModalClose}
              >
